            ...
            <li>
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Manajeman User</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{ url('ChangePass') }}">Ganti Password</a></li>
                        </ol>
                    </nav>
                </div>
            </li>
            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content-area">
                    ...
                    {{ csrf_field() }}
                        ...
                        <button type="submit" name="submitform" id="submitform" class="mt-4 btn btn-dark">Submit</button>
