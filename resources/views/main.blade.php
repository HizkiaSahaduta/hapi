...
<head>
    ...
    <title>HAPI Web</title>
    <link rel="icon" type="image/x-icon" href="{{ asset('outside/assets/img/rsz_hapi.png') }}">
...
<body>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".MemberMgtTreeView").each(function(index){
                if(!$(this).find("li").length){
                    var MemberMgt = document.getElementById('MemberMgt');
                    MemberMgt.style.display = 'none';
                }
            });
            ...
            $(".MasterDataTreeView").each(function(index){
                if(!$(this).find("li").length){
