...
@section('content')
<img src="{{ asset('outside/assets/img/hapi2.png') }}" class="kbt-logo" alt="logo">
    ...
    <div class="form">
        ...
        <div class="d-sm-flex justify-content-between">
           <div class="field-wrapper">
              <button type="submit" class="btn text-white" style="background-color: #e0be43; font-weight: 900; font-size: 16px" value="">
